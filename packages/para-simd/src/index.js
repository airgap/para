// Browser shim for `@lyku/para-simd`. Default path is WASM v128 kernels from
...
function alloc(n, type) {
  ...
  throw new Error(`@lyku/para-simd alloc: unsupported dtype "${type}" (browser shim supports f32 / f64)`);
}
