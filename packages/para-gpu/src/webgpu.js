// WebGPU + CPU engine for @lyku/para-gpu. Vendored here (not imported from
// the deprecated parabun-browser-shims) so this package owns its off-runtime
// backend. The @lyku/para-gpu router (./index.ts) wraps this in a unified
